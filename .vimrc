...
set autoindent
set fileformat=unix
set formatoptions=cq textwidth=79
...
map ,q <Plug>(easymotion-overwin-line)
nmap ,w <Plug>(easymotion-overwin-f2)

" change from insert to command
:inoremap jj <ESC>

" sudo apt-get install xclip
" to paste = cv
" copy line = cP
" default copy in VISUAL mode = cp
" cpiw = copy word
