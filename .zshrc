...
plugins=(git mercurial command-not-found dircycle dirhistory dnf docker history jsontools last-working-dir npm nyan osx pip python sudo svn svn-fast-info taskwarrior tmux tmuxinator web-search)
